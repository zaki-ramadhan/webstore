<button type="button" wire:loading.attr="disabled" wire:click="remove" wire:loading.class=" border-red-400"
    class="inline-flex items-center justify-center ml-auto px-[0.45rem] py-0.5 text-sm font-medium text-red-500 border-[1.35px] border-transparent rounded-lg cursor-pointer gap-x-2 hover:bg-slate-50 hover:border-red-400 active:outline-hidden active:bg-slate-100 disabled:opacity-50 disabled:cursor-default disabled:px-3 disabled:py-2 disabled:border-red-400/70">
